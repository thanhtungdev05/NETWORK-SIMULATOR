											...
											<div class="main_item">
                                                <table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata" style="margin:5px 0px;">
                                                        ...
                                                        <tr height="25px" style="background-color:#e6e6e6;">
                                                               ...
                                                               <INPUT TYPE="HIDDEN" NAME="uiCurTime" VALUE="N/A (Can&apos;t find NTP server)" style="background-color:transparent;border:0" disabled>
                                                ...
                                                <table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata">
                                                        <tr height="30px">
                                                                ...
                                                                <td align=left class="tabdata">
                                                                        ...
                                                                        <!--<INPUT NAME="uiViewSyncWith" TYPE="RADIO"  onclick="doTimeChange();doDisplay();" VALUE="0"  checked>
                                                                        NTP Server automatically 
                                                                        <INPUT TYPE="RADIO" NAME="uiViewSyncWith" VALUE="1" onClick="syncwithpc();doDisplay();"  >
                                                                        PC's Clock
                                                                        <INPUT TYPE="RADIO" NAME="uiViewSyncWith" VALUE="2"  onClick="doTimeChange();doDisplay();" > 
                                                                        Manually -->
                                                                </td>
                                                        </tr>
                                                </table>
                                                        ...
                                                        <table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata">
                                                                <tr height="30px">
                                                                        ...
                                                                        <td align=left class="tabdata">
                                                                                <SELECT NAME="uiViewdateToolsTZ" SIZE="1" style="width:330px;">
                                                                                     ...
                                                                                     <option value="GMT+07:00" selected>(GMT+07:00) Bangkok, Jakarta, Hanoi
                                                                ...
                                                                <tr>
                                                                    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata"><div align=right>
                                                                     Daylight Saving  </div>    <td class="tabdata"><div align=center>:</div></td><td class="tabdata">
                                                                        <INPUT TYPE="RADIO" NAME="uiViewdateDS" VALUE="Enable"     >      Enable         
                                                                        <INPUT TYPE="RADIO" NAME="uiViewdateDS" VALUE="Disable" checked >     Disable </td>
                                                                  </tr>
                                                                  -->  
                                                                ...
                                                                <tr height="30px">
                                                                        ...
                                                                        <td align=left class="tabdata">
                                                                                <INPUT TYPE="TEXT" NAME="uiViewSNTPServer" SIZE="24" MAXLENGTH="48" VALUE="vn.pool.ntp.org" >         <!--(0.0.0.0: Default Value)--> 
                                                                        </td>
                                                                </tr>
                                                                        ...
                                                                        <tr height="30px">
                                                                                ...
                                                                                <td align=left class="tabdata">
                                                                                     <INPUT TYPE="TEXT" NAME="uiViewSNTPServer2" SIZE="24" MAXLENGTH="48" VALUE="asia.pool.ntp.org" >         <!--(0.0.0.0: Default Value)-->
                                                                                </td>
                                                                        </tr>
                                        ...
                                        <div id="button0" class="main_item">
                                                ...
                                                <table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata">
                                                        <tr height="30px">
                                                                ...
                                                                <INPUT TYPE="HIDDEN" NAME="ntp3ServerFlag" VALUE="N/A">
                                                        </tr>
                                                </table>
                                        </div>
                                </div>
