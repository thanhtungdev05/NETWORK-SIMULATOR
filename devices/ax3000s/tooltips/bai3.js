...
window.TOOLTIPS_AX3000S['LAB_AX3000S_03'] = [
  ...
  // Chọn Advance
  {
    selector: '#layer2-leaf-advance .dt, #layer2-leaf-advance',
    text: 'Chọn Advance',
    position: 'right',
  ...
  // Bước 1: Wi-Fi Network_3 (IOT WiFi)
  {
    ...
    text: 'Bước 1: Chọn Wi-Fi Network_3 (IOT WiFi)',
    position: 'top',
  ...
  // Tooltip này và các tooltip phía sau CHỈ HÌNH THÀNH khi phần mở rộng .active được kích hoạt (nhờ sibling selector `.active + .collapsible-content`)
  {
    ...
    text: 'Tắt Band Steering (Khuyến nghị)',
    position: 'right',
    page: 'wlanMapSettingAll',
    expected: 'false'
  },
  // Bước 2: Tick chọn Enable (Bật 2.4GHz)
  {
    ...
    text: 'Bước 2: Tick chọn Enable (Bật 2.4GHz)',
    position: 'right',
    page: 'wlanMapSettingAll',
    expected: 'on'
  },
  // Bước 3: Đặt tên Wi-Fi IOT (2.4G) FPT Telecom-IoT
  {
    ...
    text: 'Bước 3: Đặt tên Wi-Fi IOT (2.4G) FPT Telecom-IoT',
    position: 'right',
    page: 'wlanMapSettingAll',
  ...
  // Bước 4: Đặt mật khẩu IOT (2.4G) 19006600
  {
    ...
    text: 'Bước 4: Đặt mật khẩu IOT (2.4G) 19006600',
    position: 'right',
    page: 'wlanMapSettingAll',
    expected: '19006600'
  },
  // Bước 5: Tick chọn Enable (Bật 5GHz)
  {
    ...
    text: 'Bước 5: Tick chọn Enable (Bật 5GHz)',
    position: 'right',
    page: 'wlanMapSettingAll',
    expected: 'on'
  },
  // Bước 6: Đặt tên Wi-Fi IOT (5G) FPT Telecom-IoT
  {
    ...
    text: 'Bước 6: Đặt tên Wi-Fi IOT (5G) FPT Telecom-IoT',
    position: 'right',
    page: 'wlanMapSettingAll',
    expected: 'FPT Telecom-IoT'
  },
  // Bước 7: Đặt mật khẩu IOT (5G) 19006600
  {
    ...
    text: 'Bước 7: Đặt mật khẩu IOT (5G) 19006600',
    position: 'right',
    page: 'wlanMapSettingAll',
    expected: '19006600'
  },
