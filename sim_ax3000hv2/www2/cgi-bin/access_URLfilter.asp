...
function init()
{
//      if(document.UrlFilterform.RuleIndex_active[0].checked)
//              UrlfilterOnOff(0);
//      else
//              UrlfilterOnOff(1); 
                                ...
                                <div id="block1">
                                        ...
                                        <table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata"  >
                                                <tr height="30px">
                                                        ...
                                                        <td align=left class="tabdata">
                                                                <INPUT type=radio  value=1 name=RuleIndex_active onClick="UrlfilterOnOff(0)">  Enable  
                                        ...
                                        <table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata" >
                                                ...
                                                <tr height="30px">
                                                        ...
                                                        <td align=left class="tabdata">
                                                                ...
                                                                &nbsp;&nbsp;&nbsp;&nbsp;<INPUT type=radio  value=0 name=SingleRule_active onClick="SingleRuleOnOff(1)">  Disable
                                                        </td>
                                                </tr>
                                                </table>
                                        </div>
