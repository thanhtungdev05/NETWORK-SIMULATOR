...
<!--cindy modify 12/05
			<INPUT TYPE="RADIO" NAME="ipVerRadio" VALUE="IPv4"  onClick="doIPVersionChangeIPv4()"> IPv4 
&nbsp;<INPUT TYPE="RADIO" NAME="ipVerRadio" VALUE="IPv4/IPv6" checked onClick="doIPVersionChangeIPv4()"> IPv4/IPv6 
&nbsp;<input type="RADIO" name="ipVerRadio" value="IPv6"  onClick="doIPVersionChangeIPv4()"> IPv6
-->
</td>
	</tr>
</table>
...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
     <tr><td colspan="5" height="10">&nbsp;</td></tr>
		...
		<td width="150" > </td>
		<td width="10"> </td>
		<td width="150" height="30" class="title-main">Dynamic IP</td><!--wang modify title-main-right to title-main-->
		<td width="10" ></td>		
		<td width="440"> </td>
	</tr>
...
<td align=left class="tabdata" style="width:250px;padding-left:20px;">
		Bridge Interface</td>
   <td align=left class="tabdata">
			<INPUT TYPE="RADIO" NAME="wan_BridgeInterface0" VALUE="Yes" checked > Enable         
			&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" NAME="wan_BridgeInterface0" VALUE="No"   > Disable </td>
	</tr>
...
<td align=left class="tabdata" style="width:250px;padding-left:20px;">
		IGMP Proxy</td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="wan_IGMP0" VALUE="Yes"  >  Enable 
			&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" NAME="wan_IGMP0" VALUE="No"  checked >  Disable </td>
	</tr>
...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<td align=left class="tabdata" style="width:250px;padding-left:20px;">
		Bridge Interface </td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="wan_BridgeInterface1" VALUE="Yes" checked > Enable         
			<INPUT TYPE="RADIO" NAME="wan_BridgeInterface1" VALUE="No"   > Disable </td>
	</tr>
...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">			
	...
	<td align=left class="tabdata" style="width:250px;padding-left:20px;">	
		IGMP Proxy</td>
		<td width="440" class="tabdata">
			<INPUT TYPE="RADIO" NAME="wan_IGMP1" VALUE="Yes"  >  Enable 
			&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" NAME="wan_IGMP1" VALUE="No"  checked >  Disable </td>
	</tr>
</table>
...
<tr height="30px">
	...
	<td align=left class="tabdata" style="width:250px;padding-left:20px;">	
		Bridge Interface</td>
		<td class="tabdata">
			<input type="RADIO" name="wan_BridgeInterface2" value="Yes" checked > Enable  
          		&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" NAME="wan_BridgeInterface2" VALUE="No"   > Disable </td>
	</tr>
...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed" >	
	<tr  id="ipv4_iptv" height="30px">
		...
		<td align=left class="tabdata">
			<INPUT TYPE="RADIO" NAME="wan_IPTV" VALUE="Yes"  >  Enable&nbsp;&nbsp;&nbsp;&nbsp;
			<INPUT TYPE="RADIO" NAME="wan_IPTV" VALUE="No"  checked >  Disable
		</td>
	</tr>
...
<!--	<tr height="30px">
	...
	<td align=left class="tabdata" style="width:250px;padding-left:20px;">
		IGMP Proxy </td>
		<td width="440" class="tabdata">
			<INPUT TYPE="RADIO" NAME="wan_IGMP2" VALUE="Yes"  >  Enable         
			&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" NAME="wan_IGMP2" VALUE="No"  checked >  Disable </td>
	</tr>
