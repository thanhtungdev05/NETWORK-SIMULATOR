...
var aryISP = new Array("2","3", "3", "3", "3", "3", "3", "3","3","3","3");
...
<div id="pagestyle">
<div id="contenttype">
<INPUT type="hidden" name="Route_num" value="3">
<INPUT TYPE="HIDDEN" NAME="delnum">
<!--
<INPUT TYPE="HIDDEN" NAME="editnum">
-->
<INPUT TYPE="HIDDEN" NAME="user_def_num" value="0">
        ...
        <div id="block1" class="main_item">
                ...
                <table width="600px" border="0"  cellpadding="0" cellspacing="0"  >
                        ...
                        <tr>
                                ...
                                <table width="640"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC"  >
                                <tr  bgcolor=#FFFFFF height=30><td width="40" align=center class="tabdata" ><strong>Index</strong></td>
                                        <td width="100" align=center class="tabdata"><strong> Dest IP </strong></td>
                                        <td width="100" align=center class="tabdata"><strong> Mask</strong> </td>
                                        <td width="100" align=center class="tabdata"><strong> Gateway IP</strong> </td>
                                        <td width="60"  align=center class="tabdata" ><strong> Metric</strong> </td>
                                        <td width="60" align=center class="tabdata"> <strong>Device</strong> </td>
                                        <td width="80" align=center class="tabdata"><strong> Edit</strong> </td>
                                        <!--
                                        <td align=center class="tablelisttitle">Drop </td>
                                        -->
                </tr>
                        ...
                        <td align=center class=tabdata>0</td><td align=center class=tabdata>192.168.1.0</td>
                        <td align=center class=tabdata>255.255.255.0</td><td align=center class=tabdata>0.0.0.0</td>
                        <td align=center class=tabdata>0</td><td align=center class=tabdata>br0</td>
                                ...
                                <td align=center class="topborderstyle">
                                                ...
                                                <!--
                                                <td align=center class="topborderstyle">&nbsp;</td>
                                                -->
                        </tr>
                                ...
                                <tr bgcolor=#FFFFFF height=30 id=tablebutton>
                        <td align=center class=tabdata>1</td><td align=center class=tabdata>127.0.0.0</td>
                        <td align=center class=tabdata>255.255.0.0</td><td align=center class=tabdata>0.0.0.0</td>
                        <td align=center class=tabdata>0</td><td align=center class=tabdata>lo</td>
                                ...
                                <tr bgcolor=#FFFFFF height=30 id=tablebutton>
                        <td align=center class=tabdata>2</td><td align=center class=tabdata>239.0.0.0</td>
                        <td align=center class=tabdata>255.0.0.0</td><td align=center class=tabdata>0.0.0.0</td>
                        <td align=center class=tabdata>0</td><td align=center class=tabdata>br0</td>
