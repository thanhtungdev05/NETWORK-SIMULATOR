...
function doLoad()
{
	...
	//parent.main.location="/cgi-bin/access_snmp.asp";
	parent.main.location="/cgi-bin/access_upnp.asp";
...
<ul id="MainMenu">
	...
	-->
		...
		<li style="border-bottom:1px solid #E6E6E6;"><a href="/cgi-bin/access_upnp.asp" target="main" style="color:#fff;" onclick="change_bg(this);" class="current"> UPnP </a></li>
	...
	-->
		...
		<li><a href="/cgi-bin/access_parentalControl.asp" target="main" onclick="change_bg(this);" class="other"> Parent Control </a></li>
