						...
						<div id="block1">
							...
							<table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata">
								<tr height="30px" style="display:none">
								    	<td width="20px">&nbsp;</td>
								    		...
								    		<td width="340px" align=left class="tabdata">WAN</td>
								...
								<tr height="30px">
								    	<td width="20px">&nbsp;</td>
								    	<td width="340px" align=left class="tabdata">&gt;&gt;Testing Ethernet LAN connection</td>
								     	<td align=left class="tabdata">
								...
								<tr height="30px">
								    	<td width="20px">&nbsp;</td>
								    	<td width="340px" align=left class="tabdata">&gt;&gt;Ping www.fpt.vn ( use DHCP Pri. or Sec. DNS )</td>
								     	<td align=left class="tabdata">
								     		<script language="JavaScript" type="text/JavaScript">
											var strpingyahoo = "N/A";
								...
								<tr height="30px">
										...
										<INPUT TYPE="RADIO" NAME="pingtest_type" VALUE="Yes"  onClick="doReload()">  
										Enable 
										
										<INPUT TYPE="RADIO" NAME="pingtest_type" VALUE="No"  checked onClick="doReload()">  
										Disable 
								    	</td>
								     	<td align=left class="tabdata">
								     		<script language="JavaScript" type="text/JavaScript">
											var strpingother = "N/A";
							...
							<div id="block1">
								...
								<table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata">
									...
									<tr height="30px">
									    	...
									    	<td width="250px" align=left class="tabdata">Dest Address</td>
									     	<td align=left class="tabdata" color="#F36F22">
									     		<INPUT TYPE="TEXT" NAME="tracert_destaddr" SIZE="30" MAXLENGTH="60" VALUE="" >

									     		<script language="JavaScript" type="text/JavaScript">
												var strTracertResult = "N/A";
									...
									<INPUT TYPE="HIDDEN" NAME="tracert_result" VALUE="N/A">
								</table>
								...
								<table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata">
									<tr height="30px">
										<td width="20px">&nbsp;</td>
										<td colspan="2" align=left class="tabdata">
											<INPUT TYPE="BUTTON" NAME="TestTracertBtn" class="button1" VALUE="Start" onClick="doTracertTest();">
										</td>								
									</tr>
								</table>
							</div>
							...
							<table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata">
								...
								<tr height="30px">
								    	...
								    	<td width="250px" align=left class="tabdata">Packets Num</td>
								     	<td align=left class="tabdata">
								     		<INPUT TYPE="TEXT" NAME="TcpdumpPcapNum" SIZE="9" MAXLENGTH="4" VALUE="10" >
							...
							<table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata">
								<tr height="30px">
									...
									<td width="250px" align=left>
										<INPUT TYPE="SUBMIT" NAME="TcpStart" class="button1" VALUE="Start" onClick='start_tcpdump_settings()'>
										<INPUT TYPE="HIDDEN" NAME="TcpdumpStart" VALUE="Start">
										<INPUT TYPE="HIDDEN" NAME="Tcpdump_flag" VALUE="0">
										<INPUT TYPE="BUTTON"  class="button1" VALUE="Save " onClick='backup_tcpdump_settings()'>
									</td>
