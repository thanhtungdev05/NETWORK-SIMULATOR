...
# -*- coding: utf-8 -*-
"""
Bo thu thap giao dien H6701Q V3 (BE15000) tu thiet bi that.
Trinh duyet dang mo 192.168.5.1 se POST noi dung tung trang sang day
-> ghi thang ra o dia, khong di qua ngu canh cua Claude.

Cong 8095 (rieng cho thiet bi nay, khong dung chung voi may khac).
