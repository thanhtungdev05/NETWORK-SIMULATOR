		...
		<script language="javascript">
				...
				function doSubmit()
				{
					...
					function doLogout()
					{
						/*delCookie("uid");
						delCookie("psw");
						parent.location.href="/cgi-bin/login.asp";
				...
				{
					parent.nav.location="/cgi-bin/navigation-basic.asp";
				...
				{
					parent.nav.location="/cgi-bin/navigation-advanced.asp";
					var a=document.getElementById("MainMenu").getElementsByTagName("a");
					for(var i=0;i<a.length;i++)
					{
						a[i].className="other";
				...
				{
					parent.nav.location="/cgi-bin/navigation-access.asp";
					var a=document.getElementById("MainMenu").getElementsByTagName("a");
					for(var i=0;i<a.length;i++)
					{
						a[i].className="other";
				...
				{
					parent.nav.location="/cgi-bin/navigation-maintenance.asp";
					var a=document.getElementById("MainMenu").getElementsByTagName("a");
					for(var i=0;i<a.length;i++)
					{
						a[i].className="other";
				...
				{
					parent.nav.location="/cgi-bin/navigation-status.asp";
					var a=document.getElementById("MainMenu").getElementsByTagName("a");
					for(var i=0;i<a.length;i++)
					{
						a[i].className="other";
				...
				{
					parent.nav.location="/cgi-bin/navigation-help.asp";
					var a=document.getElementById("MainMenu").getElementsByTagName("a");
					for(var i=0;i<a.length;i++)
					{
						a[i].className="other";
								...
								<table bgcolor="#4acbd6" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td style="padding:2px 4px 2px 0;">
											<a href="/cgi-bin/logout.cgi" target="_top" style="text-decoration:none;color:#fff" onClick="doLogout()">
