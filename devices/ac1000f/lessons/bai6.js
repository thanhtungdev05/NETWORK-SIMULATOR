...
window.DEVICE_AC1000F_LESSONS.push({
  id: 'LAB_AC1000F_06',
  title: 'Bài 6 - C?u hình Remote Web',
  subtitle: 'C?u hình qu?n lý thi?t b? t? xa qua Web',
  instructions: [
    '<b>Yêu c?u:</b> C?u hình qu?n lý thi?t b? t? xa (Remote Web) v?i tài kho?n:',
  ...
  // Ràng bu?c di?u ki?n ch?m dúng Ä‘Ãºng
    grading: {
    description: 'Ki?m tra c?u hình Remote Web',
