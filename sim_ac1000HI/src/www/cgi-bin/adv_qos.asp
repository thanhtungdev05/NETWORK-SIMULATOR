...
<td align=left class="tabdata">
        <INPUT TYPE="RADIO" NAME="Qos_active" VALUE="Yes"  onclick="enableAll();init();disableqos();"> Enable&nbsp;&nbsp;&nbsp;&nbsp; 
        <INPUT TYPE="RADIO" NAME="Qos_active" VALUE="No"checked onclick="disableAll();disableqos();"> Disable 
                        </td>
                </tr>
<!--
                <tr>
...
WRR weight </td>
<td align=left class="tabdata">
                                 Highest: <INPUT TYPE="TEXT" NAME="QosWRRweight1" SIZE="1" MAXLENGTH="2" VALUE="8">
                                 High: <INPUT TYPE="TEXT" NAME="QosWRRweight2" SIZE="1" MAXLENGTH="2" VALUE="4">
                                 Medium: <INPUT TYPE="TEXT" NAME="QosWRRweight3" SIZE="1" MAXLENGTH="2" VALUE="2">
                                 Low: <INPUT TYPE="TEXT" NAME="QosWRRweight4" SIZE="1" MAXLENGTH="2" VALUE="1"> 
</td>
</tr>
...
Click "Save" to save discipline setting or click "Summary" to view qos rule list </td>
</tr>
</table>
...
<td align=left class="tabdata" style="width:250px;padding-left:20px;">
        ...
        <INPUT TYPE="BUTTON" class="button1" NAME="Qos_Summary" VALUE="Summary" onClick="onClickQosSummary();">             
                        </td>
...
<td align=left class="tabdata" style="white-space:nowrap;">
                                <INPUT TYPE="RADIO" NAME="QosRuleActive" VALUE="Yes" 
                                 onclick="formAppToPhyport(1);fromDMacToPriority(1);init();disableqosRule();"> Enable 
                                &nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" NAME="QosRuleActive" VALUE="No" 
                                checked onclick="formAppToPhyport(0);fromDMacToPriority(0);disableqosRule();"> Disable 
                        </td>
                </tr>
</table>
...
Physical Ports </td>
        ...
        <INPUT TYPE="CHECKBOX" NAME="QosPhyPortEth0" ></td>
...
<!--
                                                <td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortUsb0" ></td>
-->
...
-->
                                        ...
                                        <tr>
                                                <td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortWLANMssid0" ></td>

                                                <td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortWLANMssid1" ></td>
                                                <td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortWLANMssid2" ></td>
                                                <td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortWLANMssid3" ></td>
                                        ...
                                        <tr>
                                                <td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortWLAN11acMssid0" ></td>
                                                <td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortWLAN11acMssid1" ></td>
                                                <td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortWLAN11acMssid2" ></td>
                                                <td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortWLAN11acMssid3" ></td>
                                        </tr>
                                        <tr class="tabdata">
                                        <td class="tabdata" align=center> rai0 </td>
                                        <td class="tabdata" align=center> rai1 </td>
                                        <td class="tabdata" align=center> rai2 </td>
                                        <td class="tabdata" align=center> rai3 </td>
                                        </tr>
...
<td align=left class="tabdata">
<INPUT TYPE="TEXT" onblur=blockMask(0); NAME="QosDestIpValue" SIZE="39" MAXLENGTH="39" VALUE="">
                        </td>
                </tr>
...
Source IPv4/IPv6 </td>
<td align=left class="tabdata">
<INPUT TYPE="TEXT" onblur=blockMask(1); NAME="QosSrcIpValue" SIZE="39" MAXLENGTH="39" VALUE="">
                        </td>
                </tr>
...
<INPUT TYPE="RADIO" NAME="Qos_IPP_DSCP1" VALUE="DSCP" checked onclick="ornIppTosDscp(3)"> DSCP 
                        </td>
                </tr>
...
<tr height="30px" style="display:none">
                        ...
                        <td class="tabdata">
                                ...
                                checked onclick="reIppTosDscp(3);"> DSCP 
                        </td>
                </tr>
...
<td width="250px" align=left class="tabdata" style="padding-left:20px;">
                                ...
                                <INPUT TYPE="HIDDEN" NAME="QosMBSSIDNumberFlag" VALUE="4">
                                <INPUT TYPE="HIDDEN" NAME="Qos11acMBSSIDNumberFlag" VALUE="4">
                                <INPUT TYPE="HIDDEN" NAME="QoS1PortFlag" VALUE="N/A">
                                <INPUT TYPE="HIDDEN" NAME="QoS2PortsFlag" VALUE="N/A">
                                <INPUT TYPE="HIDDEN" NAME="wlanISExist" ID="IDwlanISExist" VALUE="On">
                                <INPUT TYPE="HIDDEN" NAME="wlan11acISExist" ID="IDwlan11acISExist" VALUE="On">
  ...
  <td align=left class="tabdata">
    <SELECT NAME="QoS_Bandwidth_Control_mac_select" SIZE="1" onchange="doMACaddressChange()">
        <OPTION value="0" selected >Manaually Enter MAC Address
                ...
                <OPTION value="D8:43:AE:2E:65:45">192.168.1.2&nbsp;-&nbsp;D8:43:AE:2E:65:45
...
var tableData = [
        ["1", "N/A",getMacWithColon("N/A"),"N/A","N/A","0"],
        ["2", "N/A",getMacWithColon("N/A"),"N/A","N/A","1"],
        ["3", "N/A",getMacWithColon("N/A"),"N/A","N/A","2"],
        ["4", "N/A",getMacWithColon("N/A"),"N/A","N/A","3"],
        ["5", "N/A",getMacWithColon("N/A"),"N/A","N/A","4"],
        ["6", "N/A",getMacWithColon("N/A"),"N/A","N/A","5"],
        ["7", "N/A",getMacWithColon("N/A"),"N/A","N/A","6"],
        ["8", "N/A",getMacWithColon("N/A"),"N/A","N/A","7"],
        ["9", "N/A",getMacWithColon("N/A"),"N/A","N/A","8"],
        ["10", "N/A",getMacWithColon("N/A"),"N/A","N/A","9"]
];
