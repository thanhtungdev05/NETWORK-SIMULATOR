                                                ...
                                                <div id="block1" class="main_item">
                                                        ...
                                                        <table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata">
                                                                ...
                                                                <tr height="30px">
                                                                        ...
                                                                        <td align=left class="tabdata">
                                                                                <INPUT TYPE="TEXT" NAME="TcpdumpPcapNum" SIZE="9" MAXLENGTH="4" VALUE="" >
                                                                ...
                                                                <tr height="30px">
																		...
																		<div id="tcpdumpbutton"></div>         
                                                                                <script language=JavaScript>
                                                                                     ...
                                                                                     if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
                                                                                     {
                                                                                     document.getElementById("tcpdumpbutton").innerHTML =xmlhttp.responseText;
                                                                                     }
                                                                                     };
                                                                                     xmlhttp.open("GET", "/cgi-bin/tcpdump_button.asp", true);
                                                                                     xmlhttp.setRequestHeader('If-Modified-Since', '0');
                                                                                     xmlhttp.send();
                                                                                     }
                                                                                </script>
