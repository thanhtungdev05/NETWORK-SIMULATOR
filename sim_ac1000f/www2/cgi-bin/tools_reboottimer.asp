...
function uiSave(){
	...
	var simData = {};
	for(var j=0; j<document.tool_reboottimer.elements.length; j++) {
		var el = document.tool_reboottimer.elements[j];
		if(el.name) {
	...
	sessionStorage.setItem('RT_simData', JSON.stringify(simData));
	...
	<body onLoad="HiddenRebootTimer()">
						...
						<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed">
							<tr height="30px">
								...
								<td align=left class="tabdata">
									...
									<INPUT TYPE="radio" NAME="reboottimer_enable" VALUE="0"  onClick="HiddenRebootTimer();" checked  > Disable 
								</td>
							</tr>
						</table>
					</div>
					...
					<div id="block1">	
						...
						<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed">
							<tr height="30px">
								...
								<td align=left class="tabdata">
									<INPUT TYPE="text" NAME="time" SIZE="7" MAXLENGTH="5"  VALUE="0" >    (hour:min)    
								</td>
							</tr>
		...
		<script>
			window.addEventListener('DOMContentLoaded', function() {
				var stored = sessionStorage.getItem('RT_simData');
				if(stored) {
					...
					sessionStorage.removeItem('RT_simData');
				}
			});
		</script>
		</form>
