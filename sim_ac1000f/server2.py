...
# -*- coding: utf-8 -*-
"""
Gia lap AC1000F (FPT Internet Hub) - dung TRANG THAT crawl tu thiet bi.
...
Chay: python server2.py [port]   (mac dinh 8080)
"""
...
if __name__ == "__main__":
    srv = make(PORT)
    print("=" * 56)
    print("  Gia lap AC1000F (FPT Internet Hub) - tu thiet bi that")
