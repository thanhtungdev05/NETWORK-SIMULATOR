...
function uiSave(){
	...
	var simData = {};
	for(var j=0; j<document.tool_wifitimer.elements.length; j++) {
		var el = document.tool_wifitimer.elements[j];
		if(el.name) {
	...
	sessionStorage.setItem('WT_simData', JSON.stringify(simData));
	...
	<body onLoad="HiddenWiFiTimer()">
						...
						<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed">
							<tr height="30px">
								...
								<td align=left class="tabdata">
									...
									<INPUT TYPE="radio" NAME="wifitimer_enable" VALUE="0"  onClick="HiddenWiFiTimer();" checked  > Disable 
								</td>
							</tr>
						</table>
					</div>
					...
					<div id="block1">		
						...
						<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed">
							<tr height="30px">
								...
								<td align=left class="tabdata">
									<INPUT TYPE="text" NAME="starttime" SIZE="7" MAXLENGTH="5"  VALUE="0" > (hour:min)    
								</td>
							</tr>
							...
							<tr height="30px">
								...
								<td align=left class="tabdata">
									<INPUT TYPE="text" NAME="endtime" SIZE="7" MAXLENGTH="5"  VALUE="0" > (hour:min)    
								</td>
							</tr>
		...
		<script>
			window.addEventListener('DOMContentLoaded', function() {
				var stored = sessionStorage.getItem('WT_simData');
				if(stored) {
					...
					sessionStorage.removeItem('WT_simData');
				}
			});
		</script>
		</form>
