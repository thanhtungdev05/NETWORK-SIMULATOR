...
<tr>
	...
	<tr height="30">
		...
		<tr>
			...
			-->
			<!--<td class="tabdata" rowspan=2 align=center bgcolor="4DB848"><div> IPP/TOS </div><div> (DSCP) </div></td> wang delete-->
			<!--cindy delete
		...
		<td align="center" class="tabdata" bgcolor="4DB848"><script>document.writeln(getStr("No"))</script></td>
		<td align="center" class="tabdata" bgcolor="4DB848">N/A </td>
 		<!--<td align="center" class="tabdata" bgcolor="4DB848">N/A </td>-->
		<td align="center" class="tabdata" bgcolor="4DB848"><div></div><div>/</div><div>~</div></td>
		<td align="center" class="tabdata" bgcolor="4DB848"><div></div><div>/</div><div>~</div></td>
