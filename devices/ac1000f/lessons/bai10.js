...
window.DEVICE_AC1000F_LESSONS.push({
  id: 'LAB_AC1000F_10',
  title: 'Bài 10 - C?u hình ch?n Web',
  subtitle: 'Thi?t l?p quy t?c l?c và ch?n truy c?p Web',
    instructions: [
    '<b>Yêu c?u:</b> C?u hình tính nang ch?n Website (URL Filter):',
  ...
  // Ràng bu?c di?u ki?n ch?m dúng Ä‘Ãºng
    grading: {
    description: 'Ki?m tra c?u hình ch?n Web',
