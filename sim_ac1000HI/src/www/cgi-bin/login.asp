        ...
        <head>
                ...
                <script language=javascript type=text/javascript>
                        ...
                        function submitform()
                        {
                                ...
                                //var cookie = "SESSIONID=0a3b9256;path=/;";
								...
								//location.replace("/cgi-bin/index.asp");
                                return true;
                        }
                                ...
                                <div id=div_visite >
                                        <form id="configform" name="configform" action="/cgi-bin/login.asp" method="get">
                                                ...
                                                <table  cellspacing="0" cellpadding="0" align="center" width="500" height="200">
														...
														<!--<tr>
															<td style="COLOR: #ff0000" align="center" colspan="3">
																<script language=javascript> 
																	var LoginTimes = '0';	  
																	if (LoginTimes > 0 && LoginTimes < 5)
																	{
																		var str = 'Input invalid username/password ' +LoginTimes + ' time';
																		document.write(str);
																	}
																</script>
															</td>
                                                ...
                                                <table cellspacing="0"  width="500" style="padding-top:20px;">
                                                        <tr height="20px">
                                                                <td width="320px"></td>
                                                                <td style="color:grey; font-family: Be Vietnam;font-size: 15px;font-weight:bold;text-align:left; padding-right:40px;">hotline</td>
                                                        </tr>

                                                        <tr height="30px">
                                                                <td width="320px"></td>
                                                                <td style="color:red; font-family: Be Vietnam;font-size: 20px;font-weight:bold;text-align:left; padding-right:40px;">1900 6600</td>
                                                        </tr>
                                                  </table>
                                                  -->
                                        </form>
