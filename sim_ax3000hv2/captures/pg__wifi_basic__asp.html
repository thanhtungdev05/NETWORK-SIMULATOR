...
var wifi_ssid_2g = "FPT Telecom\-1691";
var wifi_ft_support_2g = "0";
...
var wifi_ssid_5g = "FPT Telecom\-1691";
var wifi_ft_support_5g = "0";
var wifi_authMode_5g = "WPAPSKWPA2PSK";
...
function bandsteering_enable_switch(on_off)
{
	/*if(on_off) {//on
		document.getElementById("5g_div").style.display = "none";
		document.getElementById("2g_wifi_tips_td").innerHTML = "Wi-Fi Basic Settings";
	} else {
		document.getElementById("5g_div").style.display = "";
		document.getElementById("2g_wifi_tips_td").innerHTML = "2.4G Wi-Fi Basic Settings";
	}*/
}
...
function doLoad()
{
	...
	var bandsteering_enable = wifi_bandsteer_enable;
	/*if(bandsteering_enable == "1") {//打开双频合一
		document.getElementById("5g_div").style.display = "none";
		document.getElementById("2g_wifi_tips_td").innerHTML = "Wi-Fi Basic Settings";
	} else {
		document.getElementById("5g_div").style.display = "";
...
<form name="wifi_form" method="post" ACTION="/cgi-bin/wifi_basic.asp">
		...
		<div id="block1" class="main_item">
			<table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="margin:5px 0px;">
				<tr height="25px" style="width:100%;background:#e6e6e6;">
					<td  align="left" class="title-main" style="padding-left:20px;">Default Bandsteering Setting</td>
				</tr>
			</table>
			<table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
				<tr height="30px">
					<td width="250px" align=left class="tabdata" style="padding-left:20px;">Default Bandsteering</td>
					<td align=left class="tabdata">
						<INPUT TYPE="RADIO" NAME="bandsteering_enable" onClick="bandsteering_enable_switch(1)" VALUE="1" disabled>
						on
						&nbsp;&nbsp;&nbsp;&nbsp;
						<INPUT TYPE="RADIO" NAME="bandsteering_enable" onClick="bandsteering_enable_switch(0)" VALUE="0" disabled>
						off
					</td>
					<script>
					if (wifi_bandsteer_enable == "1") {//打开双频合一
						document.getElementsByName("bandsteering_enable")[0].checked = true;
						document.getElementsByName("bandsteering_enable")[1].checked = false;
					} else {
						document.getElementsByName("bandsteering_enable")[0].checked = false;
						document.getElementsByName("bandsteering_enable")[1].checked = true;
					}
					</script>
				</tr>
			</table>
			...
			<table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="margin:5px 0px;">
				<tr height="25px" style="width:100%;background:#e6e6e6;">
					<td  align="left" class="title-main" style="padding-left:20px;" id="2g_wifi_tips_td">2.4G Wi-Fi Basic Settings</td>
				</tr>
			</table> 
			<table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
				<tr height="30px">
					...
					<td align=left class="tabdata">
						<INPUT TYPE="RADIO" NAME="enable_SSID" onClick="wifi_enable_switch(1)" VALUE="1" disabled>
						Enable
						&nbsp;&nbsp;&nbsp;&nbsp;
						<INPUT TYPE="RADIO" NAME="enable_SSID" onClick="wifi_enable_switch(0)" VALUE="0" disabled>
						Disable
					</td>
					<script>
					if (wifi_enable_2g == "1") {
			...
			<div id="wifi_active_div" >
				<table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
					...
					<tr height="30px">
						<td width="250px" align=left class="tabdata" style="padding-left:20px;">802.11r</td>
						<td align=left class="tabdata">
							<input type="radio" name="ft_support" value="1">
							Enable
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="ft_support" value="0">
							Disable
						</td>
						<script>
						if (wifi_ft_support_2g == "1") {
							document.getElementsByName("ft_support")[0].checked = true;
							document.getElementsByName("ft_support")[1].checked = false;
						} else {
							document.getElementsByName("ft_support")[0].checked = false;
							document.getElementsByName("ft_support")[1].checked = true;
						}
						</script>
					</tr>
					<tr height="30px">
					...
					<tr height="30px" id="encrypType_tr">
						...
						<script>
						if(wifi_encrypType_2g == "TKIP")
							document.getElementsByName("TKIP_Selection")[0].value = "TKIPAES";
						else
			...
			<table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="margin:5px 0px;">
				<tr height="25px" style="width:100%;background:#e6e6e6;">
					<td  align="left" class="title-main" style="padding-left:20px;">5G Wi-Fi Basic Settings</td>
				</tr>
			</table>
			<table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
				<tr height="30px">
					<td width="250px" align=left class="tabdata" style="padding-left:20px;">SSID Enable</td>
					<td align=left class="tabdata">
						<INPUT TYPE="RADIO" NAME="enable_SSID_5g" onClick="wifi_enable_switch_5g(1)" VALUE="1" disabled>
						Enable
						&nbsp;&nbsp;&nbsp;&nbsp;
						<INPUT TYPE="RADIO" NAME="enable_SSID_5g" onClick="wifi_enable_switch_5g(0)" VALUE="0" disabled>
						Disable
					</td>
					<script>
					if (wifi_enable_5g == "1") {
			...
			<div id="wifi_active_5g_div" >
				<table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
					...
					<tr height="30px">
						<td width="250px" align=left class="tabdata" style="padding-left:20px;">802.11r</td>
						<td align=left class="tabdata">
							<input type="radio" name="ft_support_5g" value="1">
							Enable
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="ft_support_5g" value="0">
							Disable
						</td>
						<script>
						if (wifi_ft_support_5g == "1") {
							document.getElementsByName("ft_support_5g")[0].checked = true;
							document.getElementsByName("ft_support_5g")[1].checked = false;
						} else {
							document.getElementsByName("ft_support_5g")[0].checked = false;
							document.getElementsByName("ft_support_5g")[1].checked = true;
						}
						</script>
					</tr>
					<tr height="30px">
					...
					<tr height="30px" id="encrypType_5g_tr">
						...
						<script>
						if(wifi_encrypType_5g == "TKIP")
							document.getElementsByName("TKIP_Selection_5g")[0].value = "TKIPAES";
						else
