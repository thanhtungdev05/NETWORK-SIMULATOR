...
topo_json = [{
	...
	"BhType":       "Ethernet",
	"StaInfo":      [{
					"devname":      "E0-BE-03-32-3-56",
					"mac":  "e0:be:03:32:3:56",
					"ip":   "192.168.3.8",
					"medium":       "eth",
					"rssi": 0
			},{
					"devname":      "E0-BE-03-32-3-58",
					"mac":  "e0:be:03:32:3:58",
					"ip":   "192.168.3.88",
					"medium":       "eth",
					"rssi": 0
			}]
	...
	"BhType":       "",
	"StaInfo":      [{
					"devname":      "E0-BE-03-32-2-56",
					"mac":  "e0:be:03:32:2:56",
					"ip":   "192.168.2.8",
					"medium":       "eth",
					"rssi": 0
			},{
					"devname":      "E0-BE-03-32-2-58",
					"mac":  "e0:be:03:32:2:58",
					"ip":   "192.168.2.88",
					"medium":       "eth",
					"rssi": 0
			}]
	...
	"BhType":       "",
	"StaInfo":      [{
					"devname":      "E0-BE-03-32-4-56",
					"mac":  "e0:be:03:32:4:56",
					"ip":   "192.168.4.8",
					"medium":       "eth",
					"rssi": 0
			},{
					"devname":      "E0-BE-03-32-4-58",
					"mac":  "e0:be:03:32:4:58",
					"ip":   "192.168.4.88",
					"medium":       "eth",
					"rssi": 0
			}]
	...
	"BhType":       "",
	"StaInfo":      [{
					"devname":      "E0-BE-03-32-33-56",
					"mac":  "e0:be:03:32:33:56",
					"ip":   "192.168.33.8",
					"medium":       "eth",
					"rssi": 0
			},{
					"devname":      "E0-BE-03-32-33-58",
					"mac":  "e0:be:03:32:33:58",
					"ip":   "192.168.33.88",
					"medium":       "eth",
					"rssi": 0
			}]
	...
	"Role": "02",
	"Distance":     "3",
	"Mac":  "b8:4d:ee:00:00:b6",
	"IP":   "192.168.1.66",
	"UplinkMac":    "b8:4d:20:22:09:15",
	"BhType":       "",
	"StaInfo":      []
}];*/
...
function initPage(getdata)
{
	if (getdata != null)
	{
		...
		document.getElementById("meshEnableText").innerHTML = getdata.meshEnableText;
		...
		else
		{
			...
			//document.getElementById("div_MeshTopList").style.display="none";//display mesh topo in status-easymesh topo
...
{
	openWindow('../cgi-bin/mesh_topo_detail.asp?index='+topo_index, 'MeshTopoDetailInfos', 880, 500);
}
...
function writeMeshTopoTable()
{
	if( getdata.mapEnable == "1" && (getdata.deviceRole == "1"))
	{
		...
		{
			topo_json = topo_info_array;//for mesh topo tree
			var dynamicHTML = '';
			...
			{		
				...
				else if('02'==device_role)//agent
				{
					if(1==distance)
					{
						...
						if(bhType=="Ethernet")
							dynamicHTML += "<br>RSSI: N/A <br>Backhaul PhyRate: "+BhPhyRate;
						else
