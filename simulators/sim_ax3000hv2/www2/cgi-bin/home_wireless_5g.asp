...
var com_11acMode = "1";//WLan11ac_Common 11acMode
var com_bssidNum = "8";//WLan_Common BssidNum
var com_country = "VIETNAM";//WLan_Common Country
var com_countryRegion = "1";//WLan11ac_Common CountryRegionABand
...
var com_mode = "11a";//WLan_Common WirelessMode 2/8/14/15/17=>11a 11an 11anac 11ac 11ax
...
var dfs_dfsEnable = "0";//WLan11ac_DFS DfsEnable 0/1
...
var com_vht_bw="2";//WLan11ac_Common VHT_BW 0-20/40;1-20/40/80;2-20/40/80/160  ??????
var com_vht_sgi="0";//WLan11ac_Common VHT_SGI 0/1 0-800;1-400
...
var entry_WPSConfMode = "0";//WLan_Entry WPSConfMode 0-disable/1-enable? 
...
*/
	...
	if(document.WLAN.WirelessMode.selectedIndex>=1){
		document.WLAN.Is11nMode.value=1;
		document.WLAN.WMM_Selection.value=1;//add for 7552
		if(document.WLAN.WirelessMode.selectedIndex>=2){
			document.WLAN.Is11acMode.value=1;
		}else{
			document.WLAN.Is11acMode.value=0;
			document.WLAN.WLan11acVHTChannelBandwidth.value=0;//add for 7552
		}
...
//	wepidx = document.WLAN.WEP_Selection.selectedIndex;
	...
	{
		document.WLAN.BUTTON.disabled = true;
		document.WLAN.BUTTON.style.background = "#808080";
		document.WLAN.BUTTON.style.border = "1px solid #808080";
	}*/
...
function RefreshPage()
{
	...
	if(vCountryRegionABand == 13){
		if ((document.WLAN.WirelessMode.selectedIndex==1) && (document.WLAN.WLANChannelBandwidth.value == 2))
		{
		...
		else if ((document.WLAN.WirelessMode.selectedIndex>1) && (document.WLAN.WLANChannelBandwidth.value == 2))
		{
			if (document.WLAN.WLan11acVHTChannelBandwidth.value == 0)
			{
				ctlChannel_ID.options[index++] = new Option(autoText, "0");
				ctlChannel_ID.options[index++] = new Option("36", "36");
				ctlChannel_ID.options[index++] = new Option("40", "40");
			...
			if (document.WLAN.WLan11acVHTChannelBandwidth.value == 1)
			{
				ctlChannel_ID.options[index++] = new Option(autoText, "0");
				ctlChannel_ID.options[index++] = new Option("36", "36");
				ctlChannel_ID.options[index++] = new Option("40", "40");
			...
			if (document.WLAN.WLan11acVHTChannelBandwidth.value == 2)
			{
				ctlChannel_ID.options[index++] = new Option(autoText, "0");
				ctlChannel_ID.options[index++] = new Option("36", "36");
				ctlChannel_ID.options[index++] = new Option("40", "40");
...
<input type="hidden" name="WscV2Support" value="0"><!--WLan11ac_Entry0 WscV2Support:1-1;other-0-->
...
<input type="hidden" name="RTDEVICE" id="RTDEVICE_id"><!--7916-->
...
<input type="hidden" name="Is11acMode" id="Is11acMode_id">
<input type="hidden" name="Wlan_HTBW40M" id="Wlan_HTBW40M_id">
<input type="hidden" name="ExtChannFlag" id="ExtChannFlag_id">
<input type="hidden" name="isAuthenTypeSupported" value="0"><!--Info_WLan11ac isAuthenTypeSupported:Yes-1;other-0-->
<input type="hidden" name="isDot1XSupported" value="0"><!--Info_WLan11ac isDot1XSupported:Yes-1;other-0-->
<input type="hidden" name="isDot1XEnhanceSupported" value="0"><!--Info_WLan11ac isDot1XEnhanceSupported:Yes-1;other-0-->
<input type="hidden" name="wlan_VC" value="0">
<!--<input type="hidden" name="WpsStart" value="">
-->
<input type="hidden" name="BssidNum" id="BssidNum_id">
<input type="hidden" name="CountryName" id="CountryName_id">
<input type="hidden" name="hCountryRegionABand" id="hCountryRegion_id">
...
<input type="hidden" name="bharti_ssid2" value="0"><!--Info_WLan11ac isbharti:Yes-1;other-0-->
<input type="hidden" name="isPerSSIDSupport" value="1">
<script>
	document.getElementById("Is11nMode_id").value = com_11nMode;
	document.getElementById("Is11acMode_id").value = com_11acMode;
...
<table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed;">
	<tr height="30px">
		...
		<select name="Channel_ID" id="Channel_ID" size="1" onChange="doExtChaLockChange()"></select>
        Current Channel : 
...
<table width="640" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed;">
	...
	<tr height="30px">
		...
		<td align=left class="tabdata">
			<select name="WirelessMode" id="WirelessMode_id" size="1" onChange="doWirelessModeChange()">
				...
				<option value="14">11vht AC/AN/A
				<option value="15" >11vht AC/AN
				<option value="17">802.11a/n/ac/ax mixed-->
			...
			<script>
				if(com_mode == "N/A")
					document.getElementById("WirelessMode_id").value = "11ac";
				else
	...
	<tr height="30px">
		<td align=left class="tabdata" style="width:250px;padding-left:20px;">DFS</td>
		<td align=left class="tabdata">
			<input type="radio" name="dfsstate" value="1">Enable&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="dfsstate" value="0">Disable
			<script>
			if (dfs_dfsEnable == "1") {
				document.getElementsByName("dfsstate")[0].checked = true;
				document.getElementsByName("dfsstate")[1].checked = false;
			} else {
				document.getElementsByName("dfsstate")[0].checked = false;
				document.getElementsByName("dfsstate")[1].checked = true;
			}
			</script>
		</td>
	</tr>
...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed">
	<tr height="30px">
		...
		HE Bandwidth </td>
		<td align=left class="tabdata">
			<select name="WLan11acVHTChannelBandwidth" id="WLan11acVHTChannelBandwidth" onChange="doVHTBandwidthChange();">
				<option value="0">20/40 MHz</option>
				<option value="1">20/40/80 MHz</option>
				<option value="2">20/40/80/160 MHz</option>
			</select>
			<script>
				if(com_vht_bw == "N/A")
					document.getElementById("WLan11acVHTChannelBandwidth").value = "2";
				else
					document.getElementById("WLan11acVHTChannelBandwidth").value = com_vht_bw;
			</script>
		</td>
	</tr>
</table>
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed">
	<tr height="30px">
		...
		<td align=left class="tabdata">
			<select name="WLan11acVHTGuardInterval" id="WLan11acVHTGuardInterval">
				<option value="0">800 nsec</option>
				<option value="1">400 nsec</option>
			</select>
			<script>
				if(com_vht_sgi == "N/A")
					document.getElementById("WLan11acVHTGuardInterval").value = "1";
				else
					document.getElementById("WLan11acVHTGuardInterval").value = com_vht_sgi;
			</script>
		</td>
	</tr>
</table>
...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed;">
	<tr height="30px">
		...
		<td align=left class="tabdata">
			<input type="text" name="PreSharedKey1" id="PreSharedKey1" size="48" maxlength="64" onBlur="wpapskCheck(this)">(8~63 characters or 64 Hex string)
			<script>
...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed;margin:5px 0;">
	<tr height="30px">
		...
		<td align=left class="tabdata">
			<input type="text" name="PreSharedKey3" id="PreSharedKey3" size="48" maxlength="64" onBlur="wpapskCheck(this)">(8~63 characters or 64 Hex string)
				<script>
...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed;margin:5px 0;">
	<tr height="30px">
		...
		<td align=left class="tabdata">
			<input type="text" name="PreSharedKey4" id="PreSharedKey4" size="48" maxlength="64" onBlur="wpapskCheck(this)">(8~63 characters or 64 Hex string)
			<script>
...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed;margin:5px 0;">
	<tr height="30px">
		...
		<td align=left class="tabdata">
			<input type="text" name="PreSharedKey5" id="PreSharedKey5" size="48" maxlength="64" onBlur="wpapskCheck(this)">(8~63 characters or 64 Hex string)
			<script>
