...
function inValidIPAddrV2(Address)
{
  var address = Address.match("^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$");
  var digits;
  var i;
...
function inValidGatewayV01(IPAddr,Mask,Gate)
{
  var address = IPAddr.match("^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$");
  var gateway = Gate.match("^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$");
  var mask = Mask.match("^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$");
  var IPdigits;
  var Gatedigits;
  var Maskdigits;
  IPdigits = address[0].split(".");
  Gatedigits = gateway[0].split(".");
  Maskdigits = mask[0].split(".");
  
  if(!((Number(IPdigits[0]&Maskdigits[0]) == Number(Gatedigits[0]&Maskdigits[0]))
        &&(Number(IPdigits[1]&Maskdigits[1]) == Number(Gatedigits[1]&Maskdigits[1]))
        &&(Number(IPdigits[2]&Maskdigits[2]) == Number(Gatedigits[2]&Maskdigits[2]))
        &&(Number(IPdigits[3]&Maskdigits[3]) == Number(Gatedigits[3]&Maskdigits[3]))))
        {
                alert(_("InvalidGWIP") + " " + gateway);
                return true;
        }
  return false;
}
...
function inValidSubnetMaskV2(Mask)
{
  var mask = Mask.match("^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$");
  var digits;
  var bMask = 0;
...
function inValidNetAddrV01(Address,Mask)
{
  var address = Address.match("^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$");
  var mask = Mask.match("^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$");
  Ipdigits = address[0].split(".");
  Maskdigits = mask[0].split(".");
  if((Number(Maskdigits[0]&Ipdigits[0])==Number(Ipdigits[0]))
    &&(Number(Maskdigits[1]&Ipdigits[1])==Number(Ipdigits[1]))
    &&(Number(Maskdigits[2]&Ipdigits[2])==Number(Ipdigits[2]))
    &&(Number(Maskdigits[3]&Ipdigits[3])==Number(Ipdigits[3])))
    {
                alert(_("InvalidNetMask") + " " + mask);
                return true;
        }
...
function inValidIPv6AddrV2(Address1)
{
        var regExp = /^\s*((([0-9A-Fa-f]{1,4}:){7}([0-9A-Fa-f]{1,4}|:))|(([0-9A-Fa-f]{1,4}:){6}(:[0-9A-Fa-f]{1,4}|((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:))|(([0-9A-Fa-f]{1,4}:){5}(((:[0-9A-Fa-f]{1,4}){1,2})|:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:))|(([0-9A-Fa-f]{1,4}:){4}(((:[0-9A-Fa-f]{1,4}){1,3})|((:[0-9A-Fa-f]{1,4})?:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9A-Fa-f]{1,4}:){3}(((:[0-9A-Fa-f]{1,4}){1,4})|((:[0-9A-Fa-f]{1,4}){0,2}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9A-Fa-f]{1,4}:){2}(((:[0-9A-Fa-f]{1,4}){1,5})|((:[0-9A-Fa-f]{1,4}){0,3}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9A-Fa-f]{1,4}:){1}(((:[0-9A-Fa-f]{1,4}){1,6})|((:[0-9A-Fa-f]{1,4}){0,4}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(:(((:[0-9A-Fa-f]{1,4}){1,7})|((:[0-9A-Fa-f]{1,4}){0,5}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:)))(%.+)?\s*$/;
...
function inValidIPv6PrefixV2(Prefix1)
{
        var Prefix = trim(Prefix1);
        var IPv6Prefix = Prefix.match("^[0-9]{1,3}$");
