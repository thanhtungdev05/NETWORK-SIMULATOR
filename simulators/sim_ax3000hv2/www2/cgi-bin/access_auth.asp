...
<td  colspan="3" valign="middle" style="padding-right:20"><hr style="height:1px;border:none;border-top:1px solid #00A9A7;" /></td>
</tr>
</table>
        ...
        <tr>
                ...
                <td class="tabdata">
                        ...
                        <INPUT TYPE="TEXT" NAME="Auth_LOID" SIZE="30" MAXLENGTH="24" VALUE="" >
        ...
        <tr>
                ...
                <td class="tabdata">
                        ...
                        <INPUT TYPE="TEXT" NAME="Auth_Password" SIZE="30" MAXLENGTH="15" VALUE="" >
                                                ...
                                                <tr height="30px">
                                                        ...
                                                        <tr height="30px">
                                                                ...
                                                                <td align=left class="tabdata">
                                                                        <INPUT TYPE="TEXT" NAME="Auth_SN" SIZE="30" MAXLENGTH="15" disabled="true">
                                                                        <script>
                                                                                document.getElementsByName('Auth_SN')[0].value = auth_sn;
                                                                        </script>
                                                                </td>
                                                        </tr>
                                                                ...
                                                                <tr height="30px">
                                                                        ...
                                                                        <td align=left class="tabdata">
                                                                                <INPUT TYPE="TEXT" NAME="Auth_PSW" SIZE="30" MAXLENGTH="15">&nbsp;
                                                                                (max length: 10)
                                                                                <script>
                                                                                document.getElementsByName('Auth_PSW')[0].value = auth_psw;
                                                                                </script>
                                                                        </td>
                                                                </tr>
