...
window.DEVICE_AC1000F_LESSONS.push({
  id: 'LAB_AC1000F_08',
  title: 'Bài 8 - C?u hình WiFi Timer',
  subtitle: 'Lên l?ch t?t/b?t Wi-Fi t? d?ng',
    instructions: [
    '<b>Yêu c?u:</b> Lên l?ch t? d?ng b?t/t?t Wi-Fi v?i kho?ng th?i gian:',
  ...
  // Ràng bu?c di?u ki?n ch?m dúng Ä‘Ãºng
    grading: {
    description: 'Ki?m tra lên l?ch WiFi',
