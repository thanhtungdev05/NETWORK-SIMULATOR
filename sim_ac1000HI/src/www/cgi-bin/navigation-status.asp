...
function doLoad()
{
	if(parent.main.location.pathname != "/cgi-bin/status_deviceinfo.asp"//location is not status_deviceinfo.asp
		|| document.referrer.indexOf("cgi-bin/status.asp") != -1)//from status.asp(check level 1 menu)
		parent.main.location="/cgi-bin/status_deviceinfo.asp";
...
<ul id="MainMenu">
	...
	<li style="border-bottom:1px solid #E6E6E6;"><a href="/cgi-bin/wirelessSignal.asp" target="main" onclick="change_bg(this);"  class="other">  Wireless Signal  </a></li>
