...
var spinner = new Spinner(opts).spin(target);
                        ...
                        */
                        ...
                        function uiSave() 
                        {
                                ...
                                showSpin();
								if(document.tool_admin.uiViewTools_Password.value != document.tool_admin.OrgPwd.value )
        ...
        <body onLoad="fresh()" style="background:#4acbd6;">
                <FORM METHOD="POST" ACTION="/cgi-bin/tools_admin.asp" name="tool_admin">
                        ...
                        <INPUT TYPE="HIDDEN" NAME="CurrentAccess" VALUE=0>
						<INPUT TYPE="HIDDEN" NAME="OrgPwd" VALUE=admin>
                                                ...
                                                <table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="table-layout: fixed">
                                                                ...
                                                                <tr height="30px">
                                                                        ...
                                                                        <td align=left class="tabdata" color="#F36F22" style="white-space:nowrap;">
                                                                                <INPUT TYPE="PASSWORD" NAME="uiViewTools_Password" SIZE="26" MAXLENGTH="31" VALUE="">  
                                                                                (length range:1~30)    
                                                                        </td>
                                                                </tr>
                                                                ...
                                                                <tr height="30px">
                                                                        ...
                                                                        <td align=left class="tabdata" style="white-space:nowrap;">
                                                                                <INPUT TYPE="PASSWORD" NAME="uiViewTools_PasswordConfirm" SIZE="26" MAXLENGTH="31" VALUE="">    
                                                                        </td>
                                                                </tr>
